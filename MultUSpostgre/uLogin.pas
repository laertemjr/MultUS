...
uses
   uPostgreConf, uMainMenu, uDM, uGlobal;
...
begin
   ...
   dm.FDPhysPgDriverLink1.VendorLib := iniconf.ReadString('postgre', 'VendorLib', '');
   dm.FDConnection1.Params.Add('Password=' + iniconf.ReadString('postgre', 'Password', ''));
   dm.FDConnection1.Params.Add('User_Name=' + iniconf.ReadString('postgre', 'User_Name', ''));
   inicat := iniconf.ReadString('postgre', 'Database', '');
